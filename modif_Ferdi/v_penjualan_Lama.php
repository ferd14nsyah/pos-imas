...
<head>
    ...
    <meta name="description" content="Produk By Hendi.com">
    <meta name="author" content="Hendi Heryanto">
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Transaksi
                    ...
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right"><button type="submit" class="btn btn-info btn-sm">Cari Produk</button></a>
                </h1> 
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button class="btn-info" data-dismiss="modal" aria-hidden="true">Tutup</button>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2021';?> by Kelompok 2 UBSI</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
