    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 align="center" class="page-header" style="color:#fff;"><font face="Buxton Sketch">Aplikasi Point Of Sales</font> <br/>
                    <small> <font face="Buxton Sketch" color="white">Toko Elektronik</font></small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
